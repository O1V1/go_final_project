...
func (r *databaseRepository) DB() *sql.DB {
	return r.db
}

// метод initDatabase готовит базу данных к использованию
func (r *databaseRepository) InitDatabase(dbFile string) {
	var err error
...
func (r *databaseRepository) CreateDatabase() {
